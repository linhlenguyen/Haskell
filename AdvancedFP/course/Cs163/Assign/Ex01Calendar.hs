...
{-
1) This exercise is due in class on Thursday, Oct 1.
   Bring a hard copy to class.
   
2) Install GHCI on your machine as described in the notes
   discussed in class.

3) Got to the programming resource links. Find the libraries.
   Right click on "Excell.hs" and save it in the same 
   directory where you saved this file.
   
4) While you're there also right-click and download
   the "CSV.hs" library and save it in the same 
   directory where you saved this file.
   
5) Write a program that creates an Excel table that looks 
