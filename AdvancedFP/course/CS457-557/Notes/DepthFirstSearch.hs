-- Based upon King & Launchbury Depth-Frist search algorithms. 
...
mkEmpty bnds  = B.newArray bnds False

contains     :: Set s -> Vertex -> ST s Bool
contains m v  = B.readArray m v

include      :: Set s -> Vertex -> ST s ()
include m v   = B.writeArray m v True
