...
-- defined in the library Control.Monad
...
data Type ref m  where
       Tvar :: (Mutable ref m ) => (ref (Maybe (Type ref m))) -> Type ref m
       Tgen:: Int -> Type ref m
       Tarrow::(Type ref m) -> (Type ref m) -> Type ref m
       Ttuple::  [Type ref m] -> Type ref m
       Tcon:: String -> [Type ref m] -> Type ref m
