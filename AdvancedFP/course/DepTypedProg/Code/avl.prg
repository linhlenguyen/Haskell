...
rotateR :: Avl n -> Avl n
rotateR (Node More (Node Same a x b) y c) = Node Less a x (Node Same b y c)
rotateR (Node More (Node More a x b) y c) = Node Less a x (Node Less b y c)

rotateL :: Avl n -> Avl n
rotateL (Node Less a x (Node Less b y c)) = (Node More (Node More a x b) y c)
rotateL (Node Less a x (Node Same b y c)) = (Node More (Node Same a x b) y c)
